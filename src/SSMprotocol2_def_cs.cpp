/*
 * SSMprotocol2_def_cs.cpp - SSM2-protocol-definitions
 *
...
SSMprotocol2_def_cs::SSMprotocol2_def_cs()
{
	...
	<< ";;000089;5;A/C Compressor Relay"
	<< ";;000089;4;Exhaust Gas Recirculation (EGR) Solenoid Valve"
	<< ";;000089;3;Air Suction Solenoid Valve (ASV)"
	<< ";;000089;2;Positive Crankcase Ventilation (PCV) Solenoid Valve"
	<< ";;000089;1;Ventilation Control Solenoid Valve"
	<< ";;00008A;8;Fast Idle Control Device (FICD) Solenoid"
	<< ";;00008A;7;Pressure Switching Solenoid 1"
	<< ";;00008A;6;Pressure Switching Solenoid 2"
	<< ";;00008A;5;Air Assist Injector (AAI) Solenoid Valve"
	<< ";;00008A;4;Fuel Tank Sensor Control Valve"
	<< ";;00008A;3;Turbocharger Wastegate Solenoid Valve"
	<< ";;00008A;2;Exhaust Bypass Control Permit Flag"
	<< ";;00008A;1;Secondary Air Combi Valve 1"
...
const QStringList SSMprotocol2_def_cs::MBrawDefs()
{
	return _MB_defs_cs;
}


const QStringList SSMprotocol2_def_cs::SWrawDefs()
{
	return _SW_defs_cs;
}


const QStringList SSMprotocol2_def_cs::SUBDTCrawDefs()
{
	return _DTC_SUBARU_defs_cs;
}


const QStringList SSMprotocol2_def_cs::OBDDTCrawDefs()
{
	return _DTC_OBD_defs_cs;
}


const QStringList SSMprotocol2_def_cs::CCCCrawDefs()
{
	return _CC_defs_cs;
}


const QStringList SSMprotocol2_def_cs::ActuatorRawDefs()
{
	return _actuator_defs_cs;
}


const QStringList SSMprotocol2_def_cs::AdjustmentRawDefs()
{
	return _adjustment_defs_cs;
}
